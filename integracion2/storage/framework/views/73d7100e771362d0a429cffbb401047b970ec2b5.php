...
<html lang="en">
    ...
    <header>
    <a href="<?php echo url('/')?>" id='logo-uct'><img src="<?php echo e(asset('photos/logo-uct.png')); ?>"></a>
    
    <div class="container">
        <button class='user-menu'>    
            <img src="<?php echo e(URL::asset('photos/user.png')); ?>" class='user-avatar'/>            
        </button>
        <div class='box hide'>
            <ul id='menu'>
...
</html><?php /**PATH C:\Users\GH\integracion2\resources\views/header.blade.php ENDPATH**/ ?>